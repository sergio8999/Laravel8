        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
         ...
         <div class="collapse navbar-collapse d-lg-flex align-items-center flex-column" id="navbarNavAltMarkup">
            ...
            <ul id="extension-aside" class="nav flex-column align-items-start">
                <li class="nav-item">
                    <h4 id="title-dashboard" class="mt-5">Dashboard</h4>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href={{ route('dashboard.houses')}} class="nav-link d-lg-flex justify-content-center align-items-center text-light"><i class="fas fa-warehouse mr-2"></i> Alojamientos</a>
                </li>   
            </ul>
